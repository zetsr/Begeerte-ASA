...
#include "UI_NotificationManager_classes.hpp"
#include "UI_NotificationManager_parameters.hpp"
...
// Parameters:
// class UUI_Notification_C*               ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash)

class UUI_Notification_C* UUI_NotificationManager_C::CreateNotify()
{
	...
	Params::UI_NotificationManager_C_CreateNotify Parms{};
...
void UUI_NotificationManager_C::ExecuteUbergraph_UI_NotificationManager(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_NotificationManager_C_ExecuteUbergraph_UI_NotificationManager Parms{};
...
void UUI_NotificationManager_C::PlayInstalledNotification(const struct FInstallProgressMod& InstallProgressMod)
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_NotificationManager_C_PlayInstalledNotification Parms{};
