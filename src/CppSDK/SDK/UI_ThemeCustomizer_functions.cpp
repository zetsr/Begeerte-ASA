...
#include "UI_ThemeCustomizer_classes.hpp"
#include "UI_ThemeCustomizer_parameters.hpp"
...
void UUI_ThemeCustomizer_C::AddToHistory()
{
...
void UUI_ThemeCustomizer_C::CheckIfHistoryDirty()
{
	static class UFunction* Func = nullptr;
...
void UUI_ThemeCustomizer_C::ExecuteUbergraph_UI_ThemeCustomizer(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_ThemeCustomizer_C_ExecuteUbergraph_UI_ThemeCustomizer Parms{};
...
void UUI_ThemeCustomizer_C::ForwardHistoryAStep()
{
	static class UFunction* Func = nullptr;
...
class FString UUI_ThemeCustomizer_C::GetThemeSaveDirectory()
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_ThemeCustomizer_C_GetThemeSaveDirectory Parms{};
...
void UUI_ThemeCustomizer_C::OnColorChangedByColorPicker(const struct FLinearColor& Color)
{
	...
	Params::UI_ThemeCustomizer_C_OnColorChangedByColorPicker Parms{};
...
struct FEventReply UUI_ThemeCustomizer_C::OnKeyDown(const struct FGeometry& MyGeometry, const struct FKeyEvent& InKeyEvent)
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_ThemeCustomizer_C_OnKeyDown Parms{};
...
void UUI_ThemeCustomizer_C::ResetHistory()
{
	static class UFunction* Func = nullptr;
...
void UUI_ThemeCustomizer_C::RestoreToDefaults()
{
	static class UFunction* Func = nullptr;
...
void UUI_ThemeCustomizer_C::SaveToHistory()
{
	static class UFunction* Func = nullptr;
...
void UUI_ThemeCustomizer_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	...
	Params::UI_ThemeCustomizer_C_Tick Parms{};
...
void UUI_ThemeCustomizer_C::UpdateColorPickerEnabled()
{
	static class UFunction* Func = nullptr;
...
void UUI_ThemeCustomizer_C::UpdateSliderActivated()
{
	static class UFunction* Func = nullptr;
