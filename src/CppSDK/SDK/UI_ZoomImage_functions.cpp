...
#include "UI_ZoomImage_classes.hpp"
#include "UI_ZoomImage_parameters.hpp"
...
bool UUI_ZoomImage_C::BPGamepadReleased(const struct FKey& theKey)
{
	...
	Params::UI_ZoomImage_C_BPGamepadReleased Parms{};
...
bool UUI_ZoomImage_C::BPHighlightWidgetOnStart()
{
	...
	Params::UI_ZoomImage_C_BPHighlightWidgetOnStart Parms{};
...
void UUI_ZoomImage_C::ButtonCall(const struct FKey& Key, EViewState State)
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_ZoomImage_C_ButtonCall Parms{};
...
void UUI_ZoomImage_C::ExecuteUbergraph_UI_ZoomImage(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_ZoomImage_C_ExecuteUbergraph_UI_ZoomImage Parms{};
...
// Function UI_ZoomImage.UI_ZoomImage_C.FadeOut
// (BlueprintCallable, BlueprintEvent)

void UUI_ZoomImage_C::FadeOut()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_ZoomImage_C", "FadeOut");
...
void UUI_ZoomImage_C::GetScreenshotsInfo(TArray<class UTexture2DDynamic*>* screenshots, TArray<class FString>* Descriptions)
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_ZoomImage_C_GetScreenshotsInfo Parms{};
...
struct FEventReply UUI_ZoomImage_C::OnKeyDown(const struct FGeometry& MyGeometry, const struct FKeyEvent& InKeyEvent)
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_ZoomImage_C_OnKeyDown Parms{};
...
void UUI_ZoomImage_C::PlayFadeInOnBeginPlayAnim()
{
	static class UFunction* Func = nullptr;
...
void UUI_ZoomImage_C::SequenceEvent__ENTRYPOINTUI_ZoomImage()
{
	static class UFunction* Func = nullptr;
...
// Function UI_ZoomImage.UI_ZoomImage_C.SequenceEvent_SwapImage
// (BlueprintCallable, BlueprintEvent)

void UUI_ZoomImage_C::SequenceEvent_SwapImage()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_ZoomImage_C", "SequenceEvent_SwapImage");
...
void UUI_ZoomImage_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	...
	Params::UI_ZoomImage_C_Tick Parms{};
...
void UUI_ZoomImage_C::UpdateButtonsStyle()
{
	static class UFunction* Func = nullptr;
...
void UUI_ZoomImage_C::UpdatePageCounter()
{
	static class UFunction* Func = nullptr;
...
void UUI_ZoomImage_C::UpdateScreenshotDescription()
{
	static class UFunction* Func = nullptr;
...
void UUI_ZoomImage_C::UpdateScreenshotImage()
{
	static class UFunction* Func = nullptr;
...
void UUI_ZoomImage_C::UpdateToCurrentImage()
{
	static class UFunction* Func = nullptr;
